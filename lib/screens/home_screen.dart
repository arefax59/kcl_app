...
''';
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            leading: const Icon(Icons.trending_up, color: Color(0xFF1E3A8A)),
  ...
  Widget build(BuildContext context) {
    print('🔵 HomeScreen build - Drawer should be visible');
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.message, color: const Color(0xFF1E3A8A), size: 28),
            ...
            Expanded(
              child: StreamBuilder<List<Map<String, dynamic>>>(
                stream: _supabaseService.getAdminMessagesStream(null, _userId),
