...
class ChronopostScreen extends StatefulWidget {
  const ChronopostScreen({super.key});

  @override
  State<ChronopostScreen> createState() => _ChronopostScreenState();
}

class _ChronopostScreenState extends State<ChronopostScreen> {
...
''';
  ...
  Widget build(BuildContext context) {
    print('🔵 ChronopostScreen build - Drawer should be visible');
    return Scaffold(
      key: _scaffoldKey,
      drawer: _buildDrawer(),
      body: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 16),
                                StreamBuilder<List<Map<String, dynamic>>>(
                                  stream: _supabaseService.getAdminMessagesStream('chronopost', _userId),
                                  builder: (context, snapshot) {
